...
const initialInventory: InventoryItem[] = [
  ...
  { id: "1", name: "Beef Sirloin", category: "Food Ingredient", currentStock: 30, unit: "lb", lowStockThreshold: 5, costPerUnit: 10.50 },
  { id: "25", name: "Beef Tenderloin", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 25.00 },
  { id: "96", name: "Porterhouse Steak", category: "Food Ingredient", currentStock: 15, unit: "16oz", lowStockThreshold: 3, costPerUnit: 30.00 },
  { id: "97", name: "Filet Mignon", category: "Food Ingredient", currentStock: 20, unit: "8oz", lowStockThreshold: 4, costPerUnit: 23.00 },
  { id: "98", name: "Top Round Roast", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 8.50 },
  { id: "99", name: "Strip Steak", category: "Food Ingredient", currentStock: 18, unit: "12oz", lowStockThreshold: 4, costPerUnit: 20.00 },
  { id: "100", name: "Rib-Eye Steak", category: "Food Ingredient", currentStock: 12, unit: "16oz", lowStockThreshold: 3, costPerUnit: 26.00 },
  { id: "101", name: "Ground Beef (80/20)", category: "Food Ingredient", currentStock: 40, unit: "lb", lowStockThreshold: 10, costPerUnit: 5.50 },

  // Food Ingredients - Chicken
  { id: "102", name: "Chicken Breast", category: "Food Ingredient", currentStock: 50, unit: "lb", lowStockThreshold: 10, costPerUnit: 4.50 },
  { id: "103", name: "Chicken Half", category: "Food Ingredient", currentStock: 20, unit: "count", lowStockThreshold: 5, costPerUnit: 4.00 },
  { id: "104", name: "Whole Chicken", category: "Food Ingredient", currentStock: 15, unit: "count", lowStockThreshold: 3, costPerUnit: 8.00 },
  { id: "105", name: "Chicken Thighs", category: "Food Ingredient", currentStock: 30, unit: "lb", lowStockThreshold: 6, costPerUnit: 3.00 },
  { id: "106", name: "Chicken Wings", category: "Food Ingredient", currentStock: 25, unit: "lb", lowStockThreshold: 5, costPerUnit: 4.50 },
  { id: "107", name: "Ground Chicken", category: "Food Ingredient", currentStock: 20, unit: "lb", lowStockThreshold: 4, costPerUnit: 5.00 },
  { id: "108", name: "Turkey Breast", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 6.00 },

  // Food Ingredients - Pork
  { id: "32", name: "Pork Loin", category: "Food Ingredient", currentStock: 15, unit: "lb", lowStockThreshold: 3, costPerUnit: 6.50 },
  { id: "109", name: "Pulled Pork", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 9.00 },
  { id: "110", name: "Bacon", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 7.50 },
  { id: "111", name: "Ham", category: "Food Ingredient", currentStock: 8, unit: "lb", lowStockThreshold: 1, costPerUnit: 6.00 },
  { id: "112", name: "Sausage", category: "Food Ingredient", currentStock: 12, unit: "lb", lowStockThreshold: 3, costPerUnit: 4.50 },
  ...
  { id: "3", name: "Salmon Fillets", category: "Food Ingredient", currentStock: 20, unit: "lb", lowStockThreshold: 4, costPerUnit: 12.00 },
  { id: "41", name: "Shrimp (Peeled & Deveined)", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 15.00 },
  { id: "114", name: "Cod", category: "Food Ingredient", currentStock: 8, unit: "lb", lowStockThreshold: 2, costPerUnit: 9.00 },
  { id: "115", name: "Smoked Salmon", category: "Food Ingredient", currentStock: 5, unit: "lb", lowStockThreshold: 1, costPerUnit: 22.00 },
  { id: "116", name: "Tuna (Fresh)", category: "Food Ingredient", currentStock: 7, unit: "lb", lowStockThreshold: 1, costPerUnit: 18.00 },
  { id: "117", name: "Oysters", category: "Food Ingredient", currentStock: 50, unit: "count", lowStockThreshold: 10, costPerUnit: 1.25 },

  // Food Ingredients - Vegetarian/Vegan Proteins
  { id: "118", name: "Tofu (Firm)", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 3.00 },
  { id: "119", name: "Tempeh", category: "Food Ingredient", currentStock: 8, unit: "lb", lowStockThreshold: 2, costPerUnit: 4.50 },
  ...
  { id: "123", name: "Nutritional Yeast", category: "Food Ingredient", currentStock: 2, unit: "lb", lowStockThreshold: 0.5, costPerUnit: 10.00 },
  ...
  { id: "15", name: "Rice (Basmati)", category: "Food Ingredient", currentStock: 50, unit: "lb", lowStockThreshold: 10, costPerUnit: 1.13 },
  ...
  { id: "57", name: "Cream Cheese", category: "Food Ingredient", currentStock: 5, unit: "lb", lowStockThreshold: 1, costPerUnit: 3.18 },
  { id: "58", name: "Graham Cracker Crumbs", category: "Food Ingredient", currentStock: 2, unit: "lb", lowStockThreshold: 0.5, costPerUnit: 1.81 },
  { id: "59", name: "Espresso Powder", category: "Food Ingredient", currentStock: 0.1, unit: "oz", lowStockThreshold: 0.02, costPerUnit: 0.85 },
  { id: "60", name: "Ladyfingers", category: "Food Ingredient", currentStock: 10, unit: "pack", lowStockThreshold: 2, costPerUnit: 5.00 },
  { id: "61", name: "Mascarpone Cheese", category: "Food Ingredient", currentStock: 2, unit: "lb", lowStockThreshold: 0.5, costPerUnit: 11.34 },
  ...
  { id: "88", name: "Parsnips", category: "Food Ingredient", currentStock: 10, unit: "lb", lowStockThreshold: 2, costPerUnit: 1.13 },
  { id: "89", name: "Sweet Potatoes", category: "Food Ingredient", currentStock: 15, unit: "lb", lowStockThreshold: 3, costPerUnit: 0.82 },
  { id: "90", name: "Nutmeg (Ground)", category: "Food Ingredient", currentStock: 0.1, unit: "oz", lowStockThreshold: 0.02, costPerUnit: 0.43 },
