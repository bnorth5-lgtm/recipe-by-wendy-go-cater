...
export const Sidebar = () => {
  ...
  return (
    <aside className="flex flex-col h-screen w-64 bg-red-500 text-sidebar-foreground border-4 border-green-500"> {/* Keep bg-red-500 here, added border */}
      ...
      <div className="flex-1 py-4 bg-yellow-300"> {/* Replaced ScrollArea with div, added bg-yellow-300 */}
