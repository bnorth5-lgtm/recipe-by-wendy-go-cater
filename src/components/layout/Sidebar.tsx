...
export const Sidebar = () => {
  ...
  return (
    <aside className="flex flex-col h-screen w-64 bg-red-500 text-sidebar-foreground"> {/* Keep bg-red-500 here */}
      ...
      <ScrollArea className="flex-1 py-4"> {/* Removed bg-red-500 from ScrollArea */}
