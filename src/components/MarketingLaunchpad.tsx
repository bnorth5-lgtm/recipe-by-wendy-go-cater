...
This month, Catering By Wendy brought ${recipe.name} to ${recipe.eventCount} ${recipe.eventCount === 1 ? "event" : "events"} — each one executed with the precision of a five-star kitchen and the warmth of a family table. At ${perPerson} per guest, every detail was deliberate. Every moment, effortless.
  ...
  const shareToWendy = useCallback(() => {
    ...
    const body = encodeURIComponent(
      [
        `Hi Wendy,`,
        ``,
        `Here is your Marketing Launchpad brief for this month's most profitable recipe.`,
        ``,
        `━━━━━━━━━━━━━━━━━━━━━━━━━━━`,
        `TOP RECIPE: ${topRecipe.name}`,
        ...
        `Catering By Wendy · northbusinessservices@gmail.com`,
      ].join("\n")
    );
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base">
                Most Profitable Recipe — {currentMonthLabel}
              </CardTitle>
            </div>
