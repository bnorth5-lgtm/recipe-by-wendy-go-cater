  ...
  return (
    <div className="min-h-full flex flex-col items-center bg-background text-foreground p-3">
      <div className="text-center mb-4">
        <h1 className="text-4xl font-bold mb-2">Ingredients Management</h1>
      ...
      <div className="w-full max-w-4xl space-y-4">
        {/* Proteins & Meats */}
        <section className="bg-card p-3 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2 text-primary">Proteins & Meats</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <h3 className="text-lg font-medium mb-1">Poultry</h3>
              {renderIngredientList([
                "Chicken Breast", "Chicken Half", "Whole Chicken", "Chicken Thighs", "Chicken Wings", "Ground Chicken", "Turkey Breast"
              ])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Beef</h3>
              {renderIngredientList([
        ...
        <section className="bg-card p-3 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2 text-primary">🌾 Grains, Starches, & Flours</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <h3 className="text-lg font-medium mb-1">Grains</h3>
              {renderIngredientList(["Rice (white, brown, wild)", "Quinoa", "Couscous", "Farro", "Oats"])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Starches</h3>
              {renderIngredientList(["Potatoes (russet, red, sweet)", "Pasta (penne, spaghetti, lasagna sheets)", "Corn", "Cornstarch"])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Flours/Baking</h3>
              {renderIngredientList(["All-purpose flour", "Bread flour", "Cornmeal", "Breadcrumbs", "Baking powder", "Baking soda"])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Breads</h3>
        ...
        {/* Dairy & Cheeses */}
        <section className="bg-card p-3 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2 text-primary">🧀 Dairy & Cheeses</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h3 className="text-lg font-medium mb-1">Dairy</h3>
              {renderIngredientList(["Milk", "Butter", "Heavy cream", "Sour cream", "Yogurt (plain, Greek)", "Eggs"])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Cheeses (Hard/Aged)</h3>
              {renderIngredientList(["Parmesan", "Gruyère", "Aged cheddar"])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Cheeses (Soft/Fresh)</h3>
              {renderIngredientList(["Mozzarella", "Feta", "Goat cheese", "Cream cheese", "Ricotta", "Brie"])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Sauces/Mixes</h3>
        ...
        <section className="bg-card p-3 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2 text-primary">🥦 Fresh Produce (Fruits & Vegetables)</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h3 className="text-lg font-medium mb-1">Vegetables</h3>
              {renderIngredientList([
            ...
            <div>
              <h3 className="text-lg font-medium mb-1">Fruits</h3>
              {renderIngredientList([
        ...
        <section className="bg-card p-3 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2 text-primary">🥫 Pantry Staples & Spices</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <h3 className="text-lg font-medium mb-1">Oils, Fats, & Liquids</h3>
              {renderIngredientList([
            ...
            <div>
              <h3 className="text-lg font-medium mb-1">Spices & Herbs</h3>
              {renderIngredientList([
              ...
              <h3 className="text-lg font-medium mb-1 mt-2">Fresh Herbs</h3>
              {renderIngredientList(["Basil", "Mint", "Rosemary", "Thyme", "Cilantro", "Dill."])}
            </div>
            <div>
              <h3 className="text-lg font-medium mb-1">Condiments & Sauces</h3>
              {renderIngredientList([
            ...
            <div>
              <h3 className="text-lg font-medium mb-1">Baking/Dessert</h3>
              {renderIngredientList([
            ...
            <div>
              <h3 className="text-lg font-medium mb-1">Canned/Jarred</h3>
              {renderIngredientList([
