            ...
            {clients.length === 0 ? (
              ...
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="px-3 py-2">Client Name</TableHead>
                      <TableHead className="px-3 py-2">Contact Person</TableHead>
                  ...
                  <TableBody>
                    {clients.map((client) => (
                      <TableRow key={client.id}>
                        ...
                        <TableCell className="px-3 py-2">{client.contactPerson}</TableCell>
                        <TableCell className="px-3 py-2">{client.email}</TableCell>
                        <TableCell className="px-3 py-2">{client.phone}</TableCell>
